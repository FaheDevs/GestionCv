...
Vue.component('navbar', {
    ...
    <div class="container-fluid">
      ...
      <a href="#/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
        <span class="fs-3 fw-light text-white"> GESTION CV AMU </span>
      </a>

        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="#/" class="nav-link px-2 text-white fs-5"><i class="bi bi-house-door-fill"></i></a></li>
        </ul>
        ...
        <div class="text-end">
         <!-- Conditional rendering based on user login status -->
            ...
            <template v-else>
              ...
              <a type="button" class="btn btn-warning fs-4" href="#/register">Sign-up</a>
            </template>
        </div>
      </div>
    </div>
